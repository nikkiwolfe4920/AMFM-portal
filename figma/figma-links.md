...
| `2067:16268` ("Main Nav") / `3727:25276` ("Content") | Collapsed default / exposed-open states of the persistent global navigation | `GlobalNav` (`COMPONENTS.md#globalnav`) — icon set and header lockup asset are blocked (see `DESIGN.md` Known gaps), toggle interaction and most item routes are product decisions, not pixel-sourced |
